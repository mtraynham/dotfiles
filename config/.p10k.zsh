# Generated by Powerlevel10k configuration wizard on 2020-02-01 at 22:38 EST.
...
() {
  ...
  # Traynham: Custom
  typeset -g POWERLEVEL9K_VCS_STASHED_ICON='\uF64D ' # fa-list
  POWERLEVEL9K_VCS_STASHED_ICON=${(g::)POWERLEVEL9K_VCS_STASHED_ICON}

  typeset -g POWERLEVEL9K_VCS_CONFLICTED_ICON='\uF071 ' # fa-exclamation-triangle
  POWERLEVEL9K_VCS_CONFLICTED_ICON=${(g::)POWERLEVEL9K_VCS_CONFLICTED_ICON}

  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='\uF067 ' # fa-plus
  POWERLEVEL9K_VCS_STAGED_ICON=${(g::)POWERLEVEL9K_VCS_STAGED_ICON}

  typeset -g POWERLEVEL9K_VCS_UNSTAGED_ICON='\uF044 ' # fa-edit
